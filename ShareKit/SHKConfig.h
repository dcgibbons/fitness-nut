...
#define SHKMyAppName			@"Fitness Nut"
#define SHKMyAppURL				@"http://click.linksynergy.com/fs-bin/stat?id=SAUpQV4sYlg&offerid=146261&type=3&subid=0&tmpid=1826&RD_PARM1=http%253A%252F%252Fitunes.apple.com%252Fus%252Fapp%252Ffitness-nut-pro%252Fid424734288%253Fmt%253D8%2526uo%253D4%2526partnerId%253D30"
...
#define SHKFacebookKey				@"4008bfea33e71ba28ad84cf24df89ee5"
#define SHKFacebookSecret			@"95d86c15ef330ac4a13f235553df4c9b"
 ...
 */
#define SHKTwitterConsumerKey		@"tuqJiOGy2KDAYAnUwLuYjg"
#define SHKTwitterSecret			@"VgYG60QZJTnUa31bl4iBsJOHHXHBXyXEs1nDAqiWOQ"
#define SHKTwitterCallbackUrl		@"http://www.nuclearbunny.org/fitnessnut/twittercallback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"dcgibbons"
#define SHKBitLyKey					@"R_047ea427d6c2c583cc63f34a07128571"
